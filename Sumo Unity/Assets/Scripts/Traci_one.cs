...
public class Traci_one : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        {
            humanList[i].transform.position = new Vector3(humanList[i].transform.position.x + 0.01f, humanList[i].transform.position.y,
                    humanList[i].transform.position.z + 0.01f);//maps its initial position
            try
            {
    ...
    void generateHuman()
    {
        ...
        newHuman.transform.position = worldPoint;//maps its initial position
    ...
    void generateBlock()
    {
        ...
        newBlock.transform.position = worldPoint;//maps its initial position
